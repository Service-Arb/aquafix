		...
		Section { tight: true,
			div { class: "flex flex-col gap-6 md:gap-11",
				...
				div { class: "grid gap-6 md:grid-cols-3 md:gap-6",
					for step in t.steps {
						div { class: "flex flex-col gap-4 border-t-[3px] border-primary pt-5 md:pt-7",
							p { class: "font-display font-num text-[28px] md:text-[34px] font-bold text-primary", "{step.n}" }
