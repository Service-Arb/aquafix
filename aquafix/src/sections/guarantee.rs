...
use crate::{
	blocks::{CARD, Cta, CtaButton, Eyebrow, Head, Section, Tone},
	content::Lang,
};
			...
			div { class: "flex flex-col gap-4 md:gap-8",
				...
				div { class: "flex flex-col md:flex-row md:gap-6",
					for pillar in t.pillars {
						div { class: "flex gap-3.5 border-b border-rule-inverse py-4 last:border-b-0 md:flex-1 md:flex-col md:gap-3 {CARD} md:border md:border-rule-inverse md:bg-inverse-raised md:px-7 md:pb-6 md:pt-[22px]",
							span { class: "font-display font-num text-[20px] md:text-[30px] font-bold text-accent",
								"{pillar.n}"
							}
