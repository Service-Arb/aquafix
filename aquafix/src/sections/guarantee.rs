			...
			div { class: "flex flex-col gap-4 md:gap-8",
				...
				div { class: "flex flex-col md:flex-row md:gap-6",
					for pillar in t.pillars {
						div { class: "flex gap-3.5 border-b border-border py-4 last:border-b-0 md:flex-1 md:flex-col md:gap-3 md:rounded-[var(--corner-card)] md:border md:border-border md:bg-muted md:px-7 md:pb-6 md:pt-[22px]",
