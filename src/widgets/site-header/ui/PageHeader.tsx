    ...
    <header className="relative border-b border-border bg-background">
      <div className="flex items-center px-[var(--page-px)] py-2.5 md:py-[18px]">
        ...
        <div className="hidden items-center gap-5 md:flex">
          <LangSwitch locales={LOCALES} labels={i18n.labels} label={copy.t.langLabel} current={copy.locale} hrefs={hrefs} className="text-[13px] font-medium text-ink-mid" />
        ...
        <details className="md:hidden">
          ...
          <nav className="absolute inset-x-0 top-full z-20 flex flex-col gap-1 border-b border-border bg-background px-[var(--page-px)] py-3 text-[15px] font-medium text-ink-mid shadow-elevated">
            ...
            <LangSwitch locales={LOCALES} labels={i18n.labels} label={copy.t.langLabel} current={copy.locale} hrefs={hrefs} className="py-2 text-[14px] font-medium text-ink-mid" />
          </nav>
        </details>
      </div>
    </header>
