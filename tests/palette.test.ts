...
// needs no step before it. This is what keeps the committed copy honest.
describe("the brand palette", () => {
  it("is the generator's output for assets/brand.toml, byte for byte", () => {
    ...
    const expected = renderPalette("aquafix", brandFromToml(read("assets/brand.toml")), contract, "brand.toml");
